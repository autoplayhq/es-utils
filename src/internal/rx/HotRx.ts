...
import type { Disposable, DisposableLike } from "./Disposable";
...
export class HotRx<T> extends Rx<T> implements RxForView<T> {
  ...
  override tap(disposable: Disposable, tapper: Tapper<T>): DisposableLike {
    ...
    tapper(this.#value);
    return cold.tap(disposable, tapper);
  }
